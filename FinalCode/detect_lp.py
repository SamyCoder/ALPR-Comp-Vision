            ...
            if len(det):
                ...
                for vehc_id,vehc_bb in enumerate(det):
                    ...
                    if save_txt:
                        with open(txt_path + '.txt', 'a') as f:
                            f.write(f'{frame_idx+1,vehc_id,classname_matches}\n')
                    #------------------------------------------------------------------
                    '''
                    ...
                    for lp_i, lp_det in enumerate(lp_pred):  # detections per image                                                    
                        if len(lp_det):
                            ...
                            for lp_c in lp_det[:, -1].unique():
                                ...
                                lp_s += f"{n} {lp_names[int(lp_c)]}{'lp_s' * (lp_n > 1)}, "  # add to string
                            ...
                            for *xyxy_lp, conf_lp, cls_lp in reversed(lp_det):
                                ...
                                if save_img or view_img:  # Add bbox to image
                                    label_lp = f'{lp_names[int(cls_lp)]} {conf_lp:.2f} {ocr_label}'
                            #$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
                            #................................................................................# 
                ...
                #for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        label = f'{names[int(cls)]} {conf:.2f} {classname_matches}'
